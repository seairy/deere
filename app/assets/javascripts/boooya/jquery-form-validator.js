...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    LANG: {
      ...
      requiredFields: '您有非空字段未填写',
      badTime: '请输入正确的时间',
      badEmail: '您输入的电子邮箱格式不正确',
      badTelephone: '您输入的手机号码格式不正确',
      badSecurityAnswer: '您输入的安全问题答案不正确',
      badDate: '请输入正确的日期',
      lengthBadStart: '输入值必须介于 ',
      lengthBadEnd: ' 字符',
      lengthTooLongStart: '您输入的值须小于 ',
      lengthTooShortStart: '您输入的值须大于 ',
      notConfirmed: '您输入的值无法被确认',
      badDomain: '域名错误',
      badUrl: '请输入的正确的URL链接',
      badCustomVal: '请输入正确的值',
      andSpaces: ' 和空间 ',
      badInt: '您输入的值必须为数字',
      badSecurityNumber: '您输入的社保号不正确',
      badUKVatAnswer: '您输入的增值税号码不正确',
      badUKNin: '您输入的UK NIN格式不正确',
      badUKUtr: '您输入的UK UTR Number 格式不正确',
      badStrength: '您的密码安全强度太低',
      badNumberOfSelectedOptionsStart: '您至少要选择 ', 
      badNumberOfSelectedOptionsEnd: ' 个选项',
      badAlphaNumeric: '您输入的值只能包含字母或数字 ',
      badAlphaNumericExtra: ' 和 ',
      wrongFileSize: '您上传的文件太大 (最大值 %s)',
      wrongFileType: '您上传的文件格式不正确,(.png .jpeg) ',
      groupCheckedRangeStart: '请在选择 ',
      groupCheckedTooFewStart: '请至少选择 ',
      groupCheckedTooManyStart: '请选择最大的 ',
      groupCheckedEnd: ' 项目',
      badCreditCard: '您输入的信用卡号码不正确',
      badCVV: '您输入的信用卡附加码不正确',
      wrongFileDim : '您上传的图像尺寸不正确,',
      imageTooTall : '图像高度不能超过',
      imageTooWide : '图像宽度不能超过',
      imageTooSmall : '您上传的图像尺寸过小',
      min : '最小值',
      max : '最大值',
      imageRatioNotAccepted : '您上传的图像比例不正确',
      badBrazilTelephoneAnswer: '您输入的手机号码无效',
      badBrazilCEPAnswer: '输入的CEP无效',
      badBrazilCPFAnswer: '输入的CPF(公积金)无效',
      badPlPesel: '输入的PESEL无效',
      badPlNip: '您输入的NIP无效',
      badPlRegon: '您输入的REGON无效',
      badreCaptcha: '请确认您不是机器人',
      passwordComplexityStart: '密码必须包含 ',
