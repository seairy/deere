        ...
        project = Project.create!(name: 'Okra').tap do |project|
          brand = project.models.create!(name: 'brand', zh_name: '品牌', en_name: 'Brand').tap do |model|
            ...
            model.regular_properties.tap do |regular_properties_association|
              regular_properties_association.create!(name: 'name', zh_name: '名称', en_name: 'Name', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
          ...
          station = project.models.create!(name: 'station', zh_name: '工作站', en_name: 'Station').tap do |model|
            ...
            model.regular_properties.tap do |regular_properties_association|
              ...
              regular_properties_association.create!(name: 'address', zh_name: '地址', en_name: 'Address', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(maximum: 200)
              end
              regular_properties_association.create!(name: 'latitude', zh_name: '纬度', en_name: 'Lat', type: :decimal, precision: 8, scale: 6, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
              ...
              regular_properties_association.create!(name: 'longitude', zh_name: '经度', en_name: 'Long', type: :decimal, precision: 9, scale: 6, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
              ...
              regular_properties_association.create!(name: 'delivery_area', zh_name: '配送范围', en_name: 'Delivery Area', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(maximum: 200)
              end
            end
          ...
          platform = project.models.create!(name: 'platform', zh_name: '平台', en_name: 'Platform').tap do |model|
            model.create_orm_loggable!(on_create: true, on_update: true, on_destroy: true, comment_required: false)
            model.regular_properties.tap do |regular_properties_association|
              model.enumeration_properties.create!(name: 'type', zh_name: '类型', en_name: 'Type', common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
              ...
              regular_properties_association.create!(name: 'account', zh_name: '账号', en_name: 'Account', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_uniqueness_validation!
                property.create_length_validation!(maximum: 50)
              end
              regular_properties_association.create!(name: 'password', zh_name: '密码', en_name: 'Password', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(maximum: 50)
              end
              regular_properties_association.create!(name: 'mobile_number', zh_name: '手机号', en_name: 'Mobile Number', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(minimum: 11, maximum: 11)
                property.create_numericality_validation(only_integer: true)
              end
              regular_properties_association.create!(name: 'url', zh_name: '网址', en_name: 'URL', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_uniqueness_validation!
                property.create_length_validation!(maximum: 200)
          ...
          platform_order = project.models.create!(name: 'platform_order', zh_name: '平台订单', en_name: 'Platform Order').tap do |model|
            model.create_orm_loggable!(on_create: true, on_update: true, on_destroy: true, comment_required: false)
            model.regular_properties.tap do |regular_properties_association|
              regular_properties_association.create!(name: 'number', zh_name: '单号', en_name: 'Number', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_uniqueness_validation!
                property.create_length_validation!(maximum: 50)
              end
              regular_properties_association.create!(name: 'daily_number', zh_name: '日单号', en_name: 'Daily Number', type: :integer, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_numericality_validation(minimum: 0, includes_minimum: false, only_integer: true)
              end
              model.enumeration_properties.create!(name: 'payment_method', zh_name: '付款方式', en_name: 'Payment Method', common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.elements.create!([
              ...
              regular_properties_association.create!(name: 'recipient_name', zh_name: '收货人姓名', en_name: 'Recipient Name', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(maximum: 20)
              end
              model.enumeration_properties.create!(name: 'recipient_gender', zh_name: '收货人性别', en_name: 'Recipient Gender', common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.elements.create!([
              ...
              regular_properties_association.create!(name: 'recipient_mobile_number', zh_name: '收货人手机号', en_name: 'Recipient Mobile Number', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(maximum: 20)
              end
              regular_properties_association.create!(name: 'recipient_address', zh_name: '收货人地址', en_name: 'Recipient Address', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(maximum: 200)
              end
              ...
              regular_properties_association.create!(name: 'product_original_price', zh_name: '商品价格', en_name: 'Product Original Price', type: :decimal, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_numericality_validation!(only_integer: false)
              end
              regular_properties_association.create!(name: 'packing_charge', zh_name: '餐盒费', en_name: 'Packing Charge', type: :decimal, precision: 6, scale: 2, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_numericality_validation!(only_integer: false)
              end
              regular_properties_association.create!(name: 'delivery_fee', zh_name: '配送费', en_name: 'Delivery Fee', type: :decimal, precision: 6, scale: 2, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_numericality_validation!(only_integer: false)
              end
              regular_properties_association.create!(name: 'total_original_price', zh_name: '原价', en_name: 'Total Original Price', type: :decimal, precision: 8, scale: 2, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_numericality_validation!(only_integer: false)
              end
              regular_properties_association.create!(name: 'service_fee', zh_name: '服务费', en_name: 'Service Fee', type: :decimal, precision: 6, scale: 2, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_numericality_validation!(only_integer: false)
              end
              regular_properties_association.create!(name: 'revenue', zh_name: '结算额', en_name: 'Revenue', type: :decimal, precision: 6, scale: 2, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_numericality_validation!(only_integer: false)
              end
              regular_properties_association.create!(name: 'paid_at', zh_name: '付款时间', en_name: 'Paid Time', type: :datetime, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
              end
              regular_properties_association.create!(name: 'remarks', zh_name: '备注', en_name: 'Remarks', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_length_validation!(maximum: 200)
              end
            end
          end
          ...
          platform_review = project.models.create!(name: 'platform_review', zh_name: '平台评价', en_name: 'Platform Review').tap do |model|
            model.create_orm_loggable!(on_create: true, on_update: true, on_destroy: true, comment_required: false)
            model.regular_properties.tap do |regular_properties_association|
              regular_properties_association.create!(name: 'number', zh_name: '评价号', en_name: 'Number', type: :string, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
                property.create_length_validation!(maximum: 50)
              end
              ...
              regular_properties_association.create!(name: 'service_rating', zh_name: '商家评分', en_name: 'Service Rating', type: :integer, common_validation_attributes: { empty_tolerance: :none, on_actions: :all }).tap do |property|
                property.create_presence_validation!
